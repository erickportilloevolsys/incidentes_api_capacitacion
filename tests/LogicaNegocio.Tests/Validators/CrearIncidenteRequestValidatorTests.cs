...
namespace LogicaNegocio.Tests.Validators
{
    public class CrearIncidenteRequestValidatorTests
    {
        ...
        {
            var validator = new CrearIncidenteRequestValidator();
            var request = new CrearIncidenteRequest { Descripcion = "desc", IdImpacto = 0, IdPrioridad = 1, Telefono = "912345678" };
            var result = validator.Validar(request);
            Assert.False(result.EsValido);
        ...
        {
            var validator = new CrearIncidenteRequestValidator();
            var request = new CrearIncidenteRequest { Descripcion = "desc", IdImpacto = 1, IdPrioridad = 0, Telefono = "912345678" };
            var result = validator.Validar(request);
            Assert.False(result.EsValido);
        ...
        {
            var validator = new CrearIncidenteRequestValidator();
            var request = new CrearIncidenteRequest { Descripcion = "desc", IdImpacto = 1, IdPrioridad = 1, Telefono = "812345678" };
            var result = validator.Validar(request);
            Assert.False(result.EsValido);
        ...
        {
            var validator = new CrearIncidenteRequestValidator();
            var request = new CrearIncidenteRequest { Descripcion = "desc", IdImpacto = 1, IdPrioridad = 1, Telefono = "912345678" };
            var result = validator.Validar(request);
